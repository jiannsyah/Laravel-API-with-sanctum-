...
class MasterRawMaterialGroupController extends Controller
{
    ...
    {
        $logs = Audit::where('auditable_type', MasterRawMaterialGroup::class)->get();
        ...
        if (request('event')) {
            ...
            $logs = Audit::where('auditable_type', MasterRawMaterialGroup::class)->where('event', request('event'))->get();
        }
